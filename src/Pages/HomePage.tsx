    ...
    return(
        <>
            <div className="h-auto w-screen">
                ...
                <RedButtonBlock title="Nintendo Today!" />
                <RedButtonBlock title="Nintendo Switch 2" />
                <RedButtonBlock title="Online Store" />
                <RedButtonBlock title="Nintendo Switch Online + Expansion Pack" />
