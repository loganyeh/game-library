    ...
    return(
        <>
            <div className="border-b border-gray-300 h-auto w-full pb-3 md:pb-14 flex flex-col justify-start items-center">
                ...
                {/* tiles */}
                <div className="h-auto w-11/12 md:w-[740px] lg:w-[990px] flex flex-wrap justify-between">
                    {characters.characters.map((character, index) => {
                        return <div key={index} className="h-auto w-auto">
                                    <div className="h-40 md:h-44 lg:h-[240px] w-40 md:w-[168px] lg:w-[230px] bg-blue-300 rounded-lg"></div>
