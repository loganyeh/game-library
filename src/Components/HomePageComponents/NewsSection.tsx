...
function NewsSection(){
    ...
    return(
        <>
            <div className="border-b border-gray-300 h-auto w-full pb-8 md:pb-14">
                    ...
                    <div className="h-full w-11/12 md:w-[790px] flex flex-wrap justify-between">
                        {Array.from({length: 4}).map((_, index) => {
                            return <div key={index} className="h-auto w-40 md:w-44 mb-6 md:mb-8">
                                        ...
                                        <div className="h-auto w-full mt-2 md:mt-3 line-clamp-3 text-sm md:text-base text-gray-700 font-bold">Here’s the latest Nintendo Switch Online news from March</div>
