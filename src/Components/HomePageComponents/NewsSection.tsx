...
function NewsSection(){
    ...
    return(
        <>
            <div className="border-b border-gray-300 mx-3 pb-8 md:pb-14 flex flex-col items-center">
                ...
                {/* Big Articles 2x */}
                {/* <div className="border h-auto w-full xl:w-[1250px] md:flex"> */}
                    {Array.from({length: 1}).map((_, index) => {
                        return <div key={index} className="border h-auto w-full max-w-6xl mb-8">
                                    ...
                                    <div className="border text-gray-800 font-semibold text-base md:text-lg tracking-wide line-clamp-2">Get ready for some wondrous new content for Super Mario Bros. Wonder—exclusive to Nintendo Switch 2!</div>
