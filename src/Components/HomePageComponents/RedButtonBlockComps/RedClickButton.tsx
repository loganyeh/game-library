    ...
    return(
        <>
            <div className="h-auto w-full xl:w-auto flex justify-center items-center">
                <div className="border-2 border-black h-12 w-11/12 md:w-[740px] lg:w-[990px] xl:w-auto flex justify-center items-center bg-red-600 text-white font-semibold text-base tracking-wider rounded-md">
